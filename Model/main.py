...
def djikstra(pointFile):
    ...
    points_array = []
    for line in data:
        line = line.removesuffix("\n")  # Remove the newline character explicitly
        coords = line.split(",")
        points_array.append((float(coords[0]), float(coords[-1])))
# Extract start and end points
    ...
    path = wg.returnPath(image, points_array)
    pdir_path = "/Users/saumya/Desktop/hackedproject/HackED2025/View/public"
    file_path = os.path.join(pdir_path, "output2.json")
...
def main():
    ...
    cleanup_files = [
        ...
        "final_reachability_map_white.png", "final_reachability_map.png","output.txt" , "/Users/saumya/Desktop/hackedproject/HackED2025/View/public/output2.json"
    ]
